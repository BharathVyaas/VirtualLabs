...
const EventSchedulerV2 = () => {
  ...
  const getContainerStyles = () => {
    return `bg-white/[0.9] ${
      activeTab === "authenticate" && "h-[26rem] relative"
    } rounded-lg p-2 overflow-auto`;
  };

  const getSchedulerHeight = () => {
    return activeTab === "schedule" && "min-h-[450px]";
  };

  console.log(getSchedulerHeight());
    ...
    <div className="flex justify-center items-center w-full h-screen overflow-auto bg-bg bg-center-bottom bg-cover">
      <div className="xl:w-[90%] w-full mx-auto xl:mx-0">
        <div className="mx-auto w-full">
          <img src={Logo} width={300} height={50} className="h-[8vh]" />
          <main className="h-[92vh] flex flex-row justify-between">
              ...
              <Container maxWidth="md">
                <Box mt={0} mb={0}>
                  <h1
                    align="center"
                    gutterBottom
                    className="animate-pulse text-[1.6rem] md:text-[2rem] xl:text-[2.3rem] text-transparent bg-gradient-to-r from-red-800 via-blue-800 to-pink-800 bg-clip-text"
                  >
                ...
                <div className={getContainerStyles()}>
                  ...
                  {activeTab === "authenticate" && (
                    ...
                    >
                      ...
                      <div className="w-full p-2 absolute top-[40%]">
                        <Box
                          mb={2}
                          className="md:w-[70%] w-full h-auto mx-auto"
                        >
                          <TextField
                            id="email"
                        ...
                        <Box mb={2} width="70%" className="mx-auto">
                          <Button
                  ...
                  {/* Schedule tab */}
                  {activeTab === "schedule" && (
                    <div className={getSchedulerHeight()}>
                      <Box mt={2}>
                        <Box
                          display="flex"
                          width="100%"
